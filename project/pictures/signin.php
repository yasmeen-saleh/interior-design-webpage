...
<body >
<div class="header">
  <a href="#default" class="logo"><img src="pictures/vector 2.png" alt="My DESIGN" width="210px" height="80px" style="padding-bottom: 5px; padding-top:0px"></a>
...
<div class="center">
 <h1 class="welcome" style="letter-spacing: 4.8px; text-align:center; margin-top:0px;">WELCOME !</h1>
 <h1 class="welcome" style="font-size: 30px; text-align:center; margin-top:10px;">SIGN IN</h1>
<h5 class="welcome" style="letter-spacing: 1.5px; text-align:center;  font-size: 16px; margin-top:5px;">
...
?>
 ...
 <div class="left">
 <label class="welcome" for="firstname"style="font-size: 16px; letter-spacing:1px; ">First Name:</label>

 <input  type="text" placeholder="enter your first name..."  name="firstname" id="firstname">

<label class="welcome" for="lastname"style="font-size: 16px; letter-spacing:1px; ">
    Last Name:</label>
 
 <input  type="text" placeholder="enter your last name..."  name="lastname" id="lastname">


<label class="welcome" for="email"style="font-size: 16px; letter-spacing:1px; ">
    E-mail:</label>
 ...
 <div class="right">
 <label class="welcome" for="username"style="font-size: 16px; letter-spacing:1px; ">
    Username:</label>
 ...
 <label class="welcome" for="password" style="font-size: 16px; letter-spacing:1px; ">Password:</label>

<input type="password" placeholder="enter your password..."  name="password" id="password">

<label class="welcome" for="password" style="font-size: 16px; letter-spacing:1px; ">Confirm Password:</label>
...
<button  type="submit" name="signin-submit" style="color:#FFF; letter-spacing:2px;">SIGN UP</button>
 ...
 <a href="login.php"><h4 style="text-align: center ; color:#FFF; padding-right:10px; ">Already a member?</h4></a>
